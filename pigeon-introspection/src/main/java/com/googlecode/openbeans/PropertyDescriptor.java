...
public class PropertyDescriptor extends FeatureDescriptor {
	...
	@Override
	public int hashCode() {
		return BeansUtils.getHashCode(getter) + BeansUtils.getHashCode(setter) + BeansUtils.getHashCode(getPropertyType()) + BeansUtils.getHashCode(getPropertyEditorClass()) + BeansUtils.getHashCode(isBound())
