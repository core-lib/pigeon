...
class StandardBeanInfo extends SimpleBeanInfo {
	...
	private PropertyDescriptor[] introspectProperties(Class<?> stopClass) throws IntrospectionException {
		...
		HashMap<String, HashMap<Object, Object>> propertyTable = new HashMap<String, HashMap<Object, Object>>(theMethods.length);
	...
	private static void introspectGet(Method theMethod, HashMap<String, HashMap<Object, Object>> propertyTable) {
	...
	@SuppressWarnings("unchecked")
	private static void introspectSet(Method theMethod, HashMap<String, HashMap<Object, Object>> propertyTable) {
		...
		HashMap<Object, Object> table = propertyTable.get(propertyName);
		if (table == null) {
			table = new HashMap<Object, Object>();
			propertyTable.put(propertyName, table);
		}
	...
	private void fixGetSet(HashMap<String, HashMap<Object, Object>> propertyTable) throws IntrospectionException {
		...
		for (Map.Entry<String, HashMap<Object, Object>> entry : propertyTable.entrySet()) {
			...
			for (Object _getter : getters) {
				Method getter = (Method) _getter;
			...
			if (normalGetter != null) {
				...
				for (Object _setter : setters) {
					Method setter = (Method) _setter;
			...
			if (indexedGetter != null) {
				...
				for (Object _setter : setters) {
					Method setter = (Method) _setter;
					if (setter.getParameterTypes().length == 2 && setter.getParameterTypes()[0] == int.class && propertyType.equals(setter.getParameterTypes()[1])) {
	...
	private EventSetDescriptor[] introspectEvents() throws IntrospectionException {
		...
		HashMap<String, HashMap<Object, Object>> eventTable = new HashMap<String, HashMap<Object, Object>>(theMethods.length);
		...
		for (Map.Entry<String, HashMap<Object, Object>> entry : eventTable.entrySet()) {
			HashMap<Object, Object> table = entry.getValue();
	 ...
	 */
	private static void introspectListenerMethods(String type, Method theMethod, HashMap<String, HashMap<Object, Object>> methodsTable) {
		String methodName = theMethod.getName();
		if (methodName == null) {
			return;
		}
		...
		HashMap<Object, Object> table = methodsTable.get(eventName);
		if (table == null) {
			table = new HashMap<Object, Object>();
		}
		// put listener type
	...
	private static void introspectGetListenerMethods(Method theMethod, HashMap<String, HashMap<Object, Object>> methodsTable) {
