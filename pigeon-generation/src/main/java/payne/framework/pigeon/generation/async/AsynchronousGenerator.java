...
public class AsynchronousGenerator extends Generator {
	...
	public void generate(Interface _interface) throws GeneratorException, IOException {
		...
		String prefix = properties.getProperty("async-prefix");
		String suffix = properties.getProperty("async-suffix");
		Template template = engine.getTemplate(properties.getProperty("async-interface"));
