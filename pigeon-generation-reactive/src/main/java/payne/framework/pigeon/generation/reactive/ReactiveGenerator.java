 ...
 * @version 1.0.0
 */
public class ReactiveGenerator extends Generator {
	private final File directory;

	public ReactiveGenerator(String directory) throws IOException {
		this(new File(directory));
	}

	public ReactiveGenerator(File directory) throws IOException {
		super("pigeon-generation-reactive.properties");
		this.directory = directory;
	}

	public ReactiveGenerator(Properties properties, String directory) throws IOException {
		this(properties, new File(directory));
	}

	public ReactiveGenerator(Properties properties, File directory) throws IOException {
		super(properties);
		this.directory = directory;
	}

	public ReactiveGenerator(String pathToProperties, String directory) throws IOException {
		this(pathToProperties, new File(directory));
	}

	public ReactiveGenerator(String pathToProperties, File directory) throws IOException {
