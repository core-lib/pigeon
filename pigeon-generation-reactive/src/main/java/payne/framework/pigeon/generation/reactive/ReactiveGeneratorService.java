...
import payne.framework.pigeon.generation.ZipToolkit;
 ...
 */
@Open("/reactive")
public class ReactiveGeneratorService implements GeneratorService, InvocationContextAware {
	private String directory = System.getProperty("java.io.tmpdir") + "/generation/reactive/";
	private boolean cached = false;
	private InvocationContext invocationContext;

	public ReactiveGeneratorService() {
		super();
	}

	public ReactiveGeneratorService(String directory) {
		super();
		this.directory = directory;
	}

	public ReactiveGeneratorService(boolean cached) {
		super();
		this.cached = cached;
	}

	public ReactiveGeneratorService(String directory, boolean cached) {
		super();
		this.directory = directory;
		this.cached = cached;
	}
	...
	public Document generate(String implementation, String interfase) throws Exception {
		...
		synchronized (name) {
			...
			ReactiveGenerator generator = new ReactiveGenerator(source);
