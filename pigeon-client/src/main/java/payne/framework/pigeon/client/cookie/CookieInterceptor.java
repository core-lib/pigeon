...
public class CookieInterceptor implements Interceptor {
	...
	public Object intercept(Invocation invocation) throws Exception {
		...
		try {
			...
			Cookie.addRequestCookies(invocation.getProperties(), cookies != null ? cookies : new Cookie[0]);
			return invocation.invoke();
		} finally {
			Cookie[] cookies = invocation.getServerHeader() == null ? new Cookie[0] : Cookie.getResponseCookies(invocation.getProperties());
