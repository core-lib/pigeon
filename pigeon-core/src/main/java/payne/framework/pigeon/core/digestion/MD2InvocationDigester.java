...
import payne.framework.pigeon.core.exception.DigesterException;
import payne.framework.pigeon.core.toolkit.IOToolkit;
import payne.framework.pigeon.core.toolkit.InputStreamReadable;

public class MD2InvocationDigester implements InvocationDigester {
	...
	public byte[] digest(byte[] bytes, int offset, int length) throws DigesterException {
		try {
			MessageDigest digester = MessageDigest.getInstance("MD2");
