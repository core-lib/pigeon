...
public class DESedeInvocationOutputStream extends OutputStream {
	private static final String ALGORITHM = "DESede/CBC/PKCS7Padding";

	private final CipherOutputStream out;

	public DESedeInvocationOutputStream(Key key, int keysize, OutputStream out) throws Exception {
