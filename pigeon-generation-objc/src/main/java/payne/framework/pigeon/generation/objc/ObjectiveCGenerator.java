...
public class ObjectiveCGenerator extends Generator {
	...
	public ObjectiveCGenerator(File directory) throws IOException, GeneratorException {
		super("pigeon-generation-objc.properties");
		try {
	...
	protected Generation createApiInterfaceGeneration() {
		Template template = engine.getTemplate(properties.getProperty("service-interface"));
		String prefix = this.prefix;
		String suffix = properties.getProperty("interface-suffix");
		return new Generation(template, prefix, suffix);
	}

	protected Generation createApiImplementationGeneration() {
		Template template = engine.getTemplate(properties.getProperty("service-implementation"));
		String prefix = this.prefix;
		String suffix = properties.getProperty("implementation-suffix");
		return new Generation(template, prefix, suffix);
	}

	protected Generation createModelInterfaceGeneration() {
		Template template = engine.getTemplate(properties.getProperty("model-interface"));
		String prefix = this.prefix;
		String suffix = properties.getProperty("interface-suffix");
		return new Generation(template, prefix, suffix);
	}
	...
	protected Generation createModelImplementationGeneration() {
		Template template = engine.getTemplate(properties.getProperty("model-implementation"));
		String prefix = this.prefix;
		String suffix = properties.getProperty("implementation-suffix");
		return new Generation(template, prefix, suffix);
	}
